...
class User {
    ...
    /**
     * Вход пользователя (ПРОВЕРКА БЕЗ ХЭШИРОВАНИЯ)
     */
    ...
    public function register($data) {
        ...
        try {
            $result = $stmt->execute([
                ...
                $data['email'],
                $data['phone'] ?? null,
                $data['password'] // Сохраняем пароль как есть
            ]);
    ...
    /**
     * Обновление пользователя (БЕЗ ХЭШИРОВАНИЯ)
     */
    public function update($data) {
        ...
        if (isset($data['password']) && !empty($data['password'])) {
            $fields[] = "password = ?"; // Сохраняем как есть
